  ...
  <div class="admin-layout">
    <el-container>
      <el-aside width="220px" class="admin-sidebar">
        <div class="sidebar-header">⚙️ 管理后台</div>
        <el-menu :default-active="'products'" class="sidebar-menu" @select="handleMenu">
        ...
        <el-table :data="products" v-loading="loading" stripe style="width: 100%">
          ...
          <el-table-column label="图片" width="80">
            <template #default="{ row }">
              <el-image :src="row.image" style="width:50px;height:50px" fit="cover" :preview-src-list="[row.image]" />
            </template>
          </el-table-column>
...
import { Goods, HomeFilled } from '@element-plus/icons-vue'
...
<style scoped>
.admin-layout { height: calc(100vh - 72px); background: #f5f5f5; }
.admin-sidebar { background: #fff; border-right: 1px solid #e8e3dc; }
.sidebar-header { padding: 20px; font-size: 18px; font-weight: 700; color: #8B7355; border-bottom: 1px solid #e8e3dc; }
.sidebar-menu { border-right: none; }
.admin-main { padding: 24px; background: #f5f5f5; }
